...
describe('Lodging Service', () => {
    ...
    it('debería crear un alojamiento', async () => {
        ...
        sinon.stub(LodgingDAO, 'createLodging').resolves(lodgingCreated)
    ...
    it('debería obtener todos los alojamientos', async () => {
        ...
        sinon.stub(LodgingDAO, 'getAllLodgings').resolves(lodgings)
    ...
    it('debería obtener un alojamiento por ID', async () => {
        ...
        sinon.stub(LodgingDAO, 'getLodgingById').resolves(lodging)
    ...
    it('debería obtener alojamientos con filtros', async () => {
        ...
        sinon.stub(LodgingDAO, 'getLodgingsWithFilters').resolves(filtered)
    ...
    it('debería actualizar un alojamiento', async () => {
        ...
        sinon.stub(LodgingDAO, 'updateLodging').resolves(updated)
    ...
    it('debería eliminar un alojamiento', async () => {
        sinon.stub(LodgingDAO, 'deleteLodging').resolves(true)
